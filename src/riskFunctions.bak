...
#|
A sub-module that provides methods for editing player army counts.

|#

(require "initialrecruit.rkt")
;Provides all functions required for the initial recruitment phase.
